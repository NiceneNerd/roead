...
mod serde {
    ...
    const _: () = {
        ...
        impl _serde::Serialize for Vector2f {
            fn serialize<__S>(
                &self,
                __serializer: __S,
    ...
    const _: () = {
        ...
        extern crate serde as _serde;
        #[automatically_derived]
        impl<'de> _serde::Deserialize<'de> for Vector2f {
                ...
                __D: _serde::Deserializer<'de>,
            {
                ...
                struct __Visitor<'de> {
                    marker: _serde::__private::PhantomData<Vector2f>,
                ...
                impl<'de> _serde::de::Visitor<'de> for __Visitor<'de> {
                    ...
                    fn expecting(
                        ...
                        _serde::__private::Formatter::write_str(__formatter, "struct Vector2f")
                    }
                    #[inline]
                    fn visit_seq<__A>(
                        self,
                                ...
                                _serde::__private::None => {
                                    return _serde::__private::Err(
                                        _serde::de::Error::invalid_length(
                                            0usize,
                                            &"struct Vector2f with 2 elements",
                                        ),
                                    );
                                }
                            };
    ...
    const _: () = {
        ...
        extern crate serde as _serde;
        #[automatically_derived]
        impl _serde::Serialize for Vector3f {
            fn serialize<__S>(
                &self,
                __serializer: __S,
            ) -> _serde::__private::Result<__S::Ok, __S::Error>
    ...
    const _: () = {
        ...
        extern crate serde as _serde;
        #[automatically_derived]
        impl<'de> _serde::Deserialize<'de> for Vector3f {
            fn deserialize<__D>(__deserializer: __D) -> _serde::__private::Result<Self, __D::Error>
            where
                __D: _serde::Deserializer<'de>,
            {
                ...
                struct __Visitor<'de> {
                    marker: _serde::__private::PhantomData<Vector3f>,
                    lifetime: _serde::__private::PhantomData<&'de ()>,
                }
                impl<'de> _serde::de::Visitor<'de> for __Visitor<'de> {
                    type Value = Vector3f;
                    fn expecting(
                        ...
                        _serde::__private::Formatter::write_str(__formatter, "struct Vector3f")
                    }
                    #[inline]
                    fn visit_seq<__A>(
                        self,
                            ...
                            match match _serde::de::SeqAccess::next_element::<f32>(&mut __seq) {
                                ...
                                _serde::__private::None => {
                                    return _serde::__private::Err(
                                        _serde::de::Error::invalid_length(
                                            0usize,
                                            &"struct Vector3f with 3 elements",
                                        ),
                                    );
                                }
                            };
    ...
    const _: () = {
        ...
        extern crate serde as _serde;
        #[automatically_derived]
        impl _serde::Serialize for Vector4f {
            fn serialize<__S>(
                &self,
                __serializer: __S,
            ) -> _serde::__private::Result<__S::Ok, __S::Error>
    ...
    const _: () = {
        ...
        extern crate serde as _serde;
        #[automatically_derived]
        impl<'de> _serde::Deserialize<'de> for Vector4f {
            fn deserialize<__D>(__deserializer: __D) -> _serde::__private::Result<Self, __D::Error>
            where
                __D: _serde::Deserializer<'de>,
            {
                ...
                impl<'de> _serde::de::Visitor<'de> for __FieldVisitor {
                        ...
                        __E: _serde::de::Error,
                    {
                        match __value {
                            ...
                            "y" => _serde::__private::Ok(__Field::__field1),
                            "z" => _serde::__private::Ok(__Field::__field2),
                            "t" => _serde::__private::Ok(__Field::__field3),
                            _ => _serde::__private::Ok(__Field::__ignore),
                        }
                    }
                    fn visit_bytes<__E>(
                        ...
                        __E: _serde::de::Error,
                    {
                        match __value {
                            ...
                            b"y" => _serde::__private::Ok(__Field::__field1),
                            b"z" => _serde::__private::Ok(__Field::__field2),
                            b"t" => _serde::__private::Ok(__Field::__field3),
                            _ => _serde::__private::Ok(__Field::__ignore),
                        }
                    }
                }
                ...
                struct __Visitor<'de> {
                    marker: _serde::__private::PhantomData<Vector4f>,
                    lifetime: _serde::__private::PhantomData<&'de ()>,
                }
                impl<'de> _serde::de::Visitor<'de> for __Visitor<'de> {
                    type Value = Vector4f;
                    fn expecting(
                        ...
                        _serde::__private::Formatter::write_str(__formatter, "struct Vector4f")
                    }
                    #[inline]
                    fn visit_seq<__A>(
                        self,
                            ...
                            match match _serde::de::SeqAccess::next_element::<f32>(&mut __seq) {
                                ...
                                _serde::__private::None => {
                                    return _serde::__private::Err(
                                        _serde::de::Error::invalid_length(
                                            0usize,
                                            &"struct Vector4f with 4 elements",
                                        ),
                                    );
                                }
                            };
                        ...
                        __A: _serde::de::MapAccess<'de>,
                    {
                        ...
                        let __field3 = match __field3 {
                            ...
                            _serde::__private::None => {
                                match _serde::__private::de::missing_field("t") {
                                    _serde::__private::Ok(__val) => __val,
                                    _serde::__private::Err(__err) => {
                                        return _serde::__private::Err(__err);
                                    }
                ...
                const FIELDS: &'static [&'static str] = &["x", "y", "z", "t"];
                _serde::Deserializer::deserialize_struct(
                    __deserializer,
                    "Vector4f",
                    FIELDS,
                ...
                __D: _serde::Deserializer<'de>,
            {
                ...
                impl<'de> _serde::de::Visitor<'de> for __FieldVisitor {
                        ...
                        __E: _serde::de::Error,
                    {
                        match __value {
                            ...
                            "g" => _serde::__private::Ok(__Field::__field1),
                            "b" => _serde::__private::Ok(__Field::__field2),
                            "a" => _serde::__private::Ok(__Field::__field3),
                            _ => _serde::__private::Ok(__Field::__ignore),
                        }
                    }
                    fn visit_bytes<__E>(
                        ...
                        __E: _serde::de::Error,
                    {
                        match __value {
                            ...
                            b"g" => _serde::__private::Ok(__Field::__field1),
                            b"b" => _serde::__private::Ok(__Field::__field2),
                            b"a" => _serde::__private::Ok(__Field::__field3),
                            _ => _serde::__private::Ok(__Field::__ignore),
                        }
                    }
                }
                ...
                impl<'de> _serde::de::Visitor<'de> for __Visitor<'de> {
                    ...
                    fn expecting(
                        ...
                        _serde::__private::Formatter::write_str(__formatter, "struct Color")
                    }
                    #[inline]
                    fn visit_seq<__A>(
                        self,
                        ...
                        __A: _serde::de::MapAccess<'de>,
                    {
                        ...
                        let __field0 = match __field0 {
                            _serde::__private::Some(__field0) => __field0,
                            _serde::__private::None => {
                                match _serde::__private::de::missing_field("r") {
                                    _serde::__private::Ok(__val) => __val,
                                    _serde::__private::Err(__err) => {
                                        return _serde::__private::Err(__err);
                                    }
                        ...
                        let __field1 = match __field1 {
                            _serde::__private::Some(__field1) => __field1,
                            _serde::__private::None => {
                                match _serde::__private::de::missing_field("g") {
                                    _serde::__private::Ok(__val) => __val,
                                    _serde::__private::Err(__err) => {
                                        return _serde::__private::Err(__err);
                                    }
                ...
                const FIELDS: &'static [&'static str] = &["r", "g", "b", "a"];
                _serde::Deserializer::deserialize_struct(
                    __deserializer,
                    "Color",
                    FIELDS,
    ...
    const _: () = {
        ...
        extern crate serde as _serde;
        #[automatically_derived]
        impl<'de> _serde::Deserialize<'de> for Quat {
            fn deserialize<__D>(__deserializer: __D) -> _serde::__private::Result<Self, __D::Error>
            where
                __D: _serde::Deserializer<'de>,
            {
                ...
                struct __Visitor<'de> {
                    marker: _serde::__private::PhantomData<Quat>,
                    lifetime: _serde::__private::PhantomData<&'de ()>,
                }
                impl<'de> _serde::de::Visitor<'de> for __Visitor<'de> {
                    type Value = Quat;
                    fn expecting(
                        ...
                        _serde::__private::Formatter::write_str(__formatter, "struct Quat")
                    }
                    #[inline]
                    fn visit_seq<__A>(
                        self,
                ...
                __D: _serde::Deserializer<'de>,
            {
                ...
                impl<'de> _serde::de::Visitor<'de> for __FieldVisitor {
                        ...
                        __E: _serde::de::Error,
                    {
                        match __value {
                            "a" => _serde::__private::Ok(__Field::__field0),
                            "b" => _serde::__private::Ok(__Field::__field1),
                            "floats" => _serde::__private::Ok(__Field::__field2),
                            _ => _serde::__private::Ok(__Field::__ignore),
                        }
                    }
                    fn visit_bytes<__E>(
                        ...
                        __E: _serde::de::Error,
                    {
                        match __value {
                            b"a" => _serde::__private::Ok(__Field::__field0),
                            b"b" => _serde::__private::Ok(__Field::__field1),
                            b"floats" => _serde::__private::Ok(__Field::__field2),
                            _ => _serde::__private::Ok(__Field::__ignore),
                        }
                    }
                }
                ...
                impl<'de> _serde::de::Visitor<'de> for __Visitor<'de> {
                    ...
                    fn expecting(
                        ...
                        _serde::__private::Formatter::write_str(__formatter, "struct Curve")
                    }
                    #[inline]
                    fn visit_seq<__A>(
                        self,
                        ...
                        __A: _serde::de::SeqAccess<'de>,
                    {
                        ...
                        let __field2 = match match _serde::de::SeqAccess::next_element::<[f32; 30]>(
                            &mut __seq,
                        ) {
                            _serde::__private::Ok(__val) => __val,
                            _serde::__private::Err(__err) => {
                        ...
                        __A: _serde::de::MapAccess<'de>,
                    {
                        ...
                        let mut __field2: _serde::__private::Option<[f32; 30]> =
                            _serde::__private::None;
                        while let _serde::__private::Some(__key) =
                            match _serde::de::MapAccess::next_key::<__Field>(&mut __map) {
                                _serde::__private::Ok(__val) => __val,
                            ...
                            }
                        {
                            match __key {
                                ...
                                __Field::__field2 => {
                                    ...
                                    __field2 = _serde::__private::Some(
                                        match _serde::de::MapAccess::next_value::<[f32; 30]>(
                                            &mut __map,
                                        ) {
                                            _serde::__private::Ok(__val) => __val,
                                            _serde::__private::Err(__err) => {
                        ...
                        let __field2 = match __field2 {
                            _serde::__private::Some(__field2) => __field2,
                            _serde::__private::None => {
                                match _serde::__private::de::missing_field("floats") {
                                    _serde::__private::Ok(__val) => __val,
                                    _serde::__private::Err(__err) => {
                                        return _serde::__private::Err(__err);
                                    }
                ...
                const FIELDS: &'static [&'static str] = &["a", "b", "floats"];
                _serde::Deserializer::deserialize_struct(
                    __deserializer,
                    "Curve",
                    FIELDS,

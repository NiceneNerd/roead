...
using String32 = oead::FixedSafeString<32>;
using String64 = oead::FixedSafeString<64>;
using String256 = oead::FixedSafeString<256>;
struct Vector2f;
struct Vector3f;
struct Vector4f;
struct Color;
...
std::unique_ptr<ParameterObjectMap> GetParamObjsFromPio(const ParameterIO &pio);
